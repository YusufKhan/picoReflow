...
### Cost Estimate
kwh_rate        = 2.1032  # Rate in currency_type to calculate cost to run job
currency_type   = "ZAR"   # Currency Symbol to show when calculating cost to run job
...
sim_p_heat     = 800.0 # W    heating power of oven
